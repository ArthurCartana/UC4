...
//Construtor da classe (função/método que é chamado AUTOMATICAMENTE quando crio um objeto a partir desta classe). É nele quue eu defino os valores que este objeto vai ter para seus atributos.
    constructor(nomeCachorro:string, racaCachorro:string, idadeCachorro:number){
    // O atributo 'nome' desta classe vai receber como valor o que o usuário digitar (nomeCachorro)    
